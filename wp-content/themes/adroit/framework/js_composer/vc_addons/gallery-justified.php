...
vc_map( array(
    "name" => esc_html__( "KT Gallery Justified", 'adroit'),
    ...
    "params" => array(
        ...
        array(
            "type" => "kt_number",
            "heading" => esc_html__("Row Height", 'adroit'),
            "param_name" => "row_height",
            "value" => 150,
            "min" => 0,
            "max" => 1000,
            "suffix" => "px",
            "description" => esc_html__( "The preferred height of rows in pixel.", 'adroit' ),
        ),
        array(
            "type" => "kt_number",
            ...
            "max" => 50,
            "suffix" => "px",
            "description" => esc_html__( "Decide the margins between the images.", 'adroit' ),
        ),
        array(
            'type' => 'kt_switch',

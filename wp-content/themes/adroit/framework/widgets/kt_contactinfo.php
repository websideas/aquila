...
class Widget_KT_ContactInfo extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct('kt_contactinfo', esc_html__('KT: Contact info', 'adroit'), $widget_ops);
    ...
    public function form( $instance ) {
        ...
        $defaults = array( 'title' => esc_html__('Contact info', 'adroit'), 'address' => '', 'phone' => '', 'email' => '');
        ...
        <p><label for="<?php echo $this->get_field_id( 'address' ); ?>"><?php esc_html_e( 'Address:', 'adroit' ); ?></label>
        ...
        <p><label for="<?php echo $this->get_field_id( 'phone' ); ?>"><?php esc_html_e( 'Phone:', 'adroit' ); ?></label>
        ...
        <p><label for="<?php echo $this->get_field_id( 'email' ); ?>"><?php esc_html_e( 'Email:', 'adroit' ); ?></label>

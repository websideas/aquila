...
function kt_register_plugins() {
    ...
    $plugins = array(
        array(
            'name'          => 'adroit Custom Post', // The plugin name
            'slug'          => 'adroit_cp', // The plugin slug (typically the folder name)
            'source'            => KT_THEME_DIR.'recommend-plugins/adroit_cp.zip', // The plugin source

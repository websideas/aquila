    ...
    $fields_post = array(
        ...
        array(
            ...
            'options' => array(
                ...
                2     => array('url' => KT_FW_IMG . 'single/layout-1.jpg', 'alt' => esc_html__('Layout 2', 'aquila')),
                3     => array('url' => KT_FW_IMG . 'single/layout-1.jpg', 'alt' => esc_html__('Layout 3', 'aquila')),
                4     => array('url' => KT_FW_IMG . 'single/layout-1.jpg', 'alt' => esc_html__('Layout 4', 'aquila')),
                5     => array('url' => KT_FW_IMG . 'single/layout-1.jpg', 'alt' => esc_html__('Layout 5', 'aquila')),
                6     => array('url' => KT_FW_IMG . 'single/layout-1.jpg', 'alt' => esc_html__('Layout 6', 'aquila')),
            ),
            'attributes' => '',
            'std' => '',
            'tab'  => 'post_general',

...
function kt_add_option_to_vc() {
    ...
    foreach($color_arr as $item){
        ...
        $button_colors['value'][esc_html__( 'Accent color', 'aquila' )] = 'accent';
    ...
    $image_styles['value'][esc_html__( 'Border box', 'aquila' )] = 'border-box';
    $image_styles['value'][esc_html__( 'Border box Left', 'aquila' )] = 'border-left';
    $image_styles['value'][esc_html__( 'Border box Right', 'aquila' )] = 'border-right';
    $image_styles['value'][esc_html__( 'Creative Left', 'aquila' )] = 'creative-left';
    $image_styles['value'][esc_html__( 'Creative Right', 'aquila' )] = 'creative-right';
    $image_styles['value'][esc_html__( 'Creative When hover', 'aquila' )] = 'creative-hover';

...
while ( have_posts() ) : the_post();
    if($i == 1){
        ...
        echo '<div class="col-md-'.$main_column.' '.$sidebar_class.' '.$pull_class.'"><div class="row main-content blog-posts-masonry">';

        if(!$first_featured){
            printf('<div class="col-lg-%1$s col-md-%1$s article-post-item">', $article_column);
